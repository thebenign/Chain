...
ship:has("control", "sprite", "position", "velocity", "label", "particle", "geometry", "timer")

local rect = ship.geometry:new("rectangle")
rect:set(200,200,48,48,24,24, 0)
...
ship.control:on("up", function()
        ship.velocity:add(ship.position.a, .4)
        part.run = true
    end
)
...
function ship.update()
    ...
    --ship.sprite.rot = ship.position.a
    --debug_label:setText(ship.velocity.dir)
end
