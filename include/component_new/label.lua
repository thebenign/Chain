...
function label:draw()
    local adj_pos = {
        x = math.floor(self.entity.position.x + self.x - (self.entity.position.camera and camera.x or 0)),
        y = math.floor(self.entity.position.y + self.y - (self.entity.position.camera and camera.y or 0))
    }
